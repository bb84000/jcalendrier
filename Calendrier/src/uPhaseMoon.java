...
public class uPhaseMoon {
	...
	public void Get_MoonDays(String[][] MoonDays, int year){
		...
		AnPh = year-1;
		MoPh = 12;
		AJour = 1;  //pour éviter AJour + 3 > 31
		gLunes= 0;
		if (MoPh == 0) {
			MoPh = 12; 
			AnPh = AnPh - 1;   
		...
		while  (CptL < CptLMax) {
		    ...
		    if (PentPhMoyL <  2299161) {
		    	...
		    	int ALPHA= trunc((PentPhMoyL - 1867216.25) / 36524.25);
