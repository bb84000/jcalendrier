/*
 * PhaseMoon : part of Calendrier project
 * Fill an array with moon phases dates and type 
 * Syntax : Get_MoonDays(String[][] MoonDays, int year)
...
public class PhaseMoon {

	public boolean Get_MoonDays(String[][] MoonDays, int year){
